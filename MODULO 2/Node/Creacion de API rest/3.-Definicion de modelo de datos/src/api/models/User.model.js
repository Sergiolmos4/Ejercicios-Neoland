...
const UserSchema = new mongoose.Schema(
  {
    email: {
      type: String, //tipo de dato, en mayúscula la primera//
      required: true,
      trim: true, //quitamos los espacios delante y detrás//
      unique: true, // dato único que crea indexes en Mongo//
...
UserSchema.pre("save", async function (next) {
  // utiliza un function porque si o si se necesita "this"//
  try {
    this.password = await bcrypt.hash(this.password, 10); // no meter más de 10 vueltas para encriptar//
    next();
